...
Let's graph this adding light blue for the statistical standard deviation and light red for the theoretical standard deviation.

```{r}
hist(mns)
abline(v = sample.mean, col = "blue", lwd = 2)
abline(v = theoretical.mean, col = "red", lwd = 2)
abline(v = sample.mean + sqrt(sample.var), col = "green", lwd = 2)
```
